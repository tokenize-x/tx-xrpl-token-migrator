...
// BridgeNonce is a free data retrieval call binding the contract method 0x1f87a250.
//
// Solidity: function bridgeNonce() view returns(uint256)
func (_TxBridge *TxBridgeCaller) BridgeNonce(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TxBridge.contract.Call(opts, &out, "bridgeNonce")
...
//
// Solidity: function bridgeNonce() view returns(uint256)
func (_TxBridge *TxBridgeSession) BridgeNonce() (*big.Int, error) {
	return _TxBridge.Contract.BridgeNonce(&_TxBridge.CallOpts)
}

// BridgeNonce is a free data retrieval call binding the contract method 0x1f87a250.
//
// Solidity: function bridgeNonce() view returns(uint256)
func (_TxBridge *TxBridgeCallerSession) BridgeNonce() (*big.Int, error) {
	return _TxBridge.Contract.BridgeNonce(&_TxBridge.CallOpts)
}
...
// FilterBridgeInitiated is a free log retrieval operation binding the contract event 0xd40462c61b3fe8c259912a52aa38432b59cc107a7397dc1af4d539c8ec3707f9.
//
// Solidity: event BridgeInitiated(bytes32 indexed bridgeId, address indexed from, string txchainAddress, uint256 amount, uint256 nonce, uint256 timestamp)
func (_TxBridge *TxBridgeFilterer) FilterBridgeInitiated(opts *bind.FilterOpts, bridgeId [][32]byte, from []common.Address) (*TxBridgeBridgeInitiatedIterator, error) {

	var bridgeIdRule []interface{}
	for _, bridgeIdItem := range bridgeId {
		bridgeIdRule = append(bridgeIdRule, bridgeIdItem)
	}
	...
	logs, sub, err := _TxBridge.contract.FilterLogs(opts, "BridgeInitiated", bridgeIdRule, fromRule)
	if err != nil {
		return nil, err
	}
...
// WatchBridgeInitiated is a free log subscription operation binding the contract event 0xd40462c61b3fe8c259912a52aa38432b59cc107a7397dc1af4d539c8ec3707f9.
//
// Solidity: event BridgeInitiated(bytes32 indexed bridgeId, address indexed from, string txchainAddress, uint256 amount, uint256 nonce, uint256 timestamp)
func (_TxBridge *TxBridgeFilterer) WatchBridgeInitiated(opts *bind.WatchOpts, sink chan<- *TxBridgeBridgeInitiated, bridgeId [][32]byte, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TxBridge.contract.WatchLogs(opts, "BridgeInitiated", bridgeIdRule, fromRule)
	if err != nil {
		return nil, err
	}
...
// ParseBridgeInitiated is a log parse operation binding the contract event 0xd40462c61b3fe8c259912a52aa38432b59cc107a7397dc1af4d539c8ec3707f9.
//
// Solidity: event BridgeInitiated(bytes32 indexed bridgeId, address indexed from, string txchainAddress, uint256 amount, uint256 nonce, uint256 timestamp)
